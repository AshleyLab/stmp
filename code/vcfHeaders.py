# list of VCF headers from the annotated output file that are used in vcfUtils
...
# clinvar headers
kClinvarClinSigHeader = 'CLNSIG'
kClinvarClinRevStatusHeader = 'CLNREVSTAT'
...
kVCFColTypes = {
                ...
                'qual': 'varchar(127)',
                'filter': 'varchar(127)'
                # there shoudn't be a definition for the INFO col bc we're only importing specific tags
                }
# kVCFColTypeChrom = 'varchar(10)'
# kVCFColTypeStart = 'int'
# kVCFColTypeID = 'varchar(127)'
# kVCFColTypeRef = 'varchar(512)'
# kVCFColTypeAlt = 'varchar(512)'
# kVCFColTypeQual = 'varchar(127)'
# kVCFColTypeFilter = 'varchar(127)'


# for rare variant identification
